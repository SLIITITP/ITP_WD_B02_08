...
<div className="h-full px-3 py-4 overflow-y-auto bg-indigo-500 dark:bg-gray-800">
   ...
   <ul>
      ...
      <li>
      <img className="rounded-full m-auto mt-2 w-40 h-40" src={baba} alt="description"/>
      
      <li>
      <Link to = "#">
      <button type="button" className=" mt-2 mx-auto flex items-center py-2.5 px-5  mb-2 text-sm font-medium text-white focus:outline-none bg-red-600 rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
       UNENROLL</button>
       </Link>
       </li>
      ...
      <div>
         ...
         <input type="text" id="first_name" className="  mt-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"disabled/>
     </div>
   ...
   <li>
      <Link to = "/fbs/e">
       <button type="button" className=" mt-4  flex items-center gap-2 m-auto text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
        <VscFeedback/>FeedBacks</button>
        </Link>
       </li>
   <li>
      <Link to= "/smp">
      <button type="button" className=" mt-3 flex gap-1 text-gray-900 bg-purple-400 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
      <GrDocumentPdf/>Add PDF Materials</button>
      </Link>
   ...
   <li>
      <Link to = "/smN">
      <button type="button" className="flex gap-1  text-gray-900 bg-purple-400 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
      <GrNotes/>Add Notes Materials</button>
      </Link>
    ...
    <li>
      <Link to = "/smRe">
      <button type="button" className="flex gap-1  text-gray-900 bg-purple-400 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
      <GrDocumentVideo/>Add RecordMaterials</button>
      </Link>
    ...
    <li>
      <Link to="/smR">
      <button type="button" className="flex gap-1  text-gray-900 bg-purple-400 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
      <TbZoomReset/>Add Research Materials</button>
      </Link>
       ...
       <li>
         <Link to = "/">
         <button type="button" className=" mt-3 flex items-center gap-1 m-auto focus:outline-none backdrop-blur-lg text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 dark:focus:ring-yellow-900">
...
<div className="flex h-52 mb-4 rounded bg-green-300 border-black border-2 dark:bg-gray-800">
   ...
   <div className="grid grid-cols-4 gap-4 mt-4">
      <div className="flex flex-col items-center justify-center h-80 w-auto rounded bg-white shadow-lg border-2 dark:bg-gray-800">
         <Link to ="/smN">
         <p className=' text-8xl ml-10' ><GrNotes/></p>
