...
export default function TeacherNotePage() {
    const { id } = useParams();
  ...
  return (
    ...
    <h1 className=' mt-8 text-4xl text-black text-center relative font-bold'>Note Material Section</h1>
    ...
    <div className=' flex shadow-lg bg-white h-20 w-auto rounded-full justify-center p-8'>
        ...
        <div className="flex items-center">   
            ...
            <div className="relative w-full">
                ...
                <button type="button" onClick={startSpeechRecognition} className="!absolute inset-y-0 right-0 flex items-center pr-3 hover:bg-transparent">
  ...
  <div className=' float-right mr-32 mt-2'>
    <Link to="/smN/add">
     <button type="button" className="border-2 border-black mt-3 flex items-center gap-2 ml-16 focus:outline-none backdrop-blur-lg text-white bg-green-600 hover:bg-green-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 dark:focus:ring-yellow-900">
         <MdAddCircle/>Add Note</button></Link>
         </div>

  
  <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-24 ml-16 mr-16">
