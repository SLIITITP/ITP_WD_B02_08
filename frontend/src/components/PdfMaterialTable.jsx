    ...
    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        {files.map((pdf) => (
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <button type="submit" onClick={() => handleView(pdf)} className="text-white bg-orange-600 outline-black hover:shadow-lg hover:stroke-white font-medium rounded-full text-sm px-5 py-2.5 mr-1 mb-1">  
                View Details</button>
                    </Link>
