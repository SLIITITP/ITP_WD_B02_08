...
export default function Footer() {
  return (
    <div>
        <footer className="p-4 bg-blue-900 sm:p-6 dark:bg-gray-800">
    <div className="mx-auto max-w-screen-xl mt-5">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-64">
                <div>
                    <h2 className="mb-6 text-sm font-semibold uppercase text-white">About us</h2>
                    <ul className="text-white">
                        <li className="mb-4">
                            <p>Thank you for choosing Thilina Institute for your educational needs. We are committed to providing you with the best learning experience and helping you achieve your goals</p>
                        </li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white sm:text-center dark:text-white">© 2023 <Link to ="" className="hover:underline">Thilina institute™</Link>. All Rights Reserved.
            </span>
